...
<% 
    if(request.getParameter("submit"!=null)
    {
        ...
        pst = con.prepareStatement("update records set stname = ?,course =?,fees= ? where id = ?");
...
<html>
    <head>
        ...
        <title>JSP Page</title> 
         ...
         <link href="bootstrap-5.0.1-dist/bootstrap-5.0.1-dist/css/bootstrap.css" rel="stylesheet" type="text/css"/>
        <link href="bootstrap-5.0.1-dist/bootstrap-5.0.1-dist/css/bootstrap.min.css"  rel="stylesheet" type="text/css"/>
                ...
                <form  method="POST" action="#" >
                    ...
                    <div alight="left">
                     ...
                     <div alight="left">
                        ...
                        <input type="text" class="form-control" placeholder="Fee" name="fee" id="fees" value="<%= rs.getString("fees")%>" required >
                     </div>
